...
// Popup, in dem der Mitarbeiter selbst einen Verifizierungscode festlegt und ihn
// dem Kunden auf eigenem Weg mitteilt (Telefon, WhatsApp, etc.). Der Chat übernimmt
// automatisch den Hinweistext "Wir haben Ihnen einen Verifizierungscode geschickt."
  ...
  overlay.innerHTML = `
    <div class="modal" style="width:360px;">
      ...
      <form id="verify-code-form">
        <label>Code, der dem Kunden groß im Chat angezeigt wird
