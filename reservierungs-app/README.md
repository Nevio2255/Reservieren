...
1. Bei Google sicherstellen, dass die **2-Faktor-Authentifizierung aktiviert** ist
   (Voraussetzung für App-Passwörter).
2. Auf [myaccount.google.com/apppasswords](https://myaccount.google.com/apppasswords)
   gehen → neues App-Passwort erstellen (z. B. Name "LuxeFinds Verwaltung").
3. Den erzeugten 16-stelligen Code notieren (nicht das normale Google-Passwort!).
...
- **E-Mail empfangen**: alle 30 Minuten prüft eine automatische Funktion das
