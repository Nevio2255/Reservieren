...
function json(statusCode, data) {
  return {
    ...
    headers: {
      ...
      // Wichtig: Ohne diese Header darf der Browser (oder ein Proxy) die Antwort
      // auf /chat?token=... zwischenspeichern. Dadurch kam beim Live-Chat kurz
      // nach der Verifizierung wieder eine veraltete "nicht verifiziert"-Antwort
      // zurück, obwohl der Kunde bereits freigeschaltet war.
